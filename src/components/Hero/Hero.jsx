    ...
    <section className="hero flex" style={{ justifyContent: "space-evenly" }}>
      <div className="left-section">
        ...
        <div className="heading">
          <h1>Pharmacist and Fronted Developer</h1>
        </div>
        <div className="description"><p> Lorem ipsum dolor sit amet consectetur elit adipisicing . Ex
        tempore dolor in, accusantium laudantium accusamus.</p></div>
